...
public class m_maxCountry {
    ...
    private String outputFileName = "E://hadoop//maxCountry.txt";
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(m_maxCountry.class);
        //本次job作业使用的mapper类是那个？
        job.setMapperClass(m_maxCountryMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);
        //本次job作业使用的combiner类是那个？
        job.setCombinerClass(m_maxCountryCombiner.class);
        //本次job作业使用的reducer类是那个
        job.setReducerClass(m_maxCountryReducer.class);
