...
public class m_avg {
    ...
    private String outputFileName = "E://hadoop//avg.txt";
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setMapperClass(m_avgMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);
        //本次job作业使用的combiner类是那个？
        job.setCombinerClass(m_avgCombiner.class);
        //本次job作业使用的reducer类是那个
        job.setReducerClass(m_avgReducer.class);
